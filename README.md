...
For the test in this dataset, DROPBEAR consists of a 51 x 6 x 350 mm beam with two accelerometers mounted on the cantilever beam, as well as two strain gauges. 
